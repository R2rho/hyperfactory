...
export const GL = ({
  hovering,
  geometryType: externalGeometryType,
  onGeometryChange,
}: {
  hovering: boolean
  ...
  const {
    ...
    geometryType: {
      value: "grid",
      options: ["plane", "grid", "woven", "hex", "diagonal"],
    },
    size: {
      value: 512,
  ...
  const geometryType = (externalGeometryType || levaGeometryType) as "plane" | "grid" | "woven" | "hex" | "diagonal"
